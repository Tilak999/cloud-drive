...
async function createServiceAccount(uid, projectId){
    ...
    if(accntExist) return console.log(`> Skipping ${serviceAccountName} creation: Service account already present`);
...
async function main(){
    try {
        ...
        console.log(`> Creating Service Accounts.. this might take few minutes`)
        for(let i=0; i < 98; i++) {
