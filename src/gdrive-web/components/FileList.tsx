    ...
    return (
        <React.Fragment>
            ...
            <div className="block sm:hidden w-full">
                ...
                {items &&
                    items.map(
                        ({ id, name, modifiedTime, mimeType, description }) => (
                            <div
                                className="border-b-2 border-gray-100 flex flex-row py-2"
                                key={id}
                            >
